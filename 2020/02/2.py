...
password_objs = parse_input('input.txt')
# passwords_objs = parse_input('example.txt')

part1 = len(list(filter(validate1, password_objs)))
part2 = len(list(filter(validate2, password_objs)))
